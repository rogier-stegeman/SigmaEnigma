...
# Return value consist of a list with:
...
def boxFinder(seq):
    box10 = findRe(pattern='TA[ACGT]{3}T',seq=seq.upper()[35:60],start=True, add = 35) # [GT]A[ACGT]{3}[AT] TA[ACGT]{3}T
    box35 = findRe(pattern='TT[GT][ACGT]{3}',seq=seq.upper()[:35],start=False)
    box10Ext = False
    afstand = 0
